...
class L8C2PrdIdInfo:
    ...
    def __init__(self, l8_c2_prd_id:str) -> None:
        ...
        if len(elt_prd_id) == 7:
            ...
            raise ValueError('Landsat 8-9 product id not provides the 9 keys values requested!')
    ...
    def collection_category(self, value):
        ...
        if value in allowed_values:
            ...
            raise ValueError("Collection category different than " + ', '.join(allowed_values) + " is not possible!")
