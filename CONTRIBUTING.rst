...
Welcome to ``ewoc_dag`` contributor's guide.
...
If you experience bugs or general issues with ``ewoc_dag``, please have a look
...
You can help improve ``ewoc_dag`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ewoc_dag`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ewoc_dag``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ewoc_dag.git
    cd ewoc_dag
...
#. Install |pre-commit|_::
   ...
   ``ewoc_dag`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ewoc_dag
.. _issue tracker: https://github.com/<USERNAME>/ewoc_dag/issues
.. <-- end -->
